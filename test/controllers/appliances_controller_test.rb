...
class AppliancesControllerTest < ActionController::TestCase
  ...
  test "should create appliance" do
    assert_difference('Appliance.count') do
      post :create, appliance: { category_id: @appliance.category_id, hours_per_day: @appliance.hours_per_day, name: @appliance.name, watts: @appliance.watts }
    end
  ...
  test "should update appliance" do
    patch :update, id: @appliance, appliance: { category_id: @appliance.category_id, hours_per_day: @appliance.hours_per_day, name: @appliance.name, watts: @appliance.watts }
    assert_redirected_to appliance_path(assigns(:appliance))
  end
